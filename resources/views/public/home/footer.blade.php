...
<!-- AKHIR FOOTER -->
	...
	<script type="text/javascript">
		if($('.pages').text() == 'profile'){
			$(".icon-nav-profile").css({"filter": "grayscale(0%)"});
			$(".icon-nav-beranda").css({"filter": "grayscale(100%)"});
			$(".icon-nav-pesanan").css({"filter": "grayscale(100%)"});
		}
		if($('.pages').text() == 'beranda'){
			$(".icon-nav-beranda").css({"filter": "grayscale(0%)"});
			$(".icon-nav-profile").css({"filter": "grayscale(100%)"});
			$(".icon-nav-pesanan").css({"filter": "grayscale(100%)"});
		}
		if($('.pages').text() == 'pesanan'){
			$(".icon-nav-pesanan").css({"filter": "grayscale(0%)"});
			$(".icon-nav-beranda").css({"filter": "grayscale(100%)"});
			$(".icon-nav-profile").css({"filter": "grayscale(100%)"});
		}
